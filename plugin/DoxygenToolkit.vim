...
function! <SID>DoxygenLicenseFunc()
  ...
  exec "normal o".s:interCommentTag.substitute( g:DoxygenToolkit_licenseTag, "\<enter>", "\<enter>".s:interCommentBlock, "g" )." Copyright (c) ".strftime("%Y")." ".g:DoxygenToolkit_authorName
...
function! <SID>DoxygenAuthorFunc()
  ...
  exec "normal o".s:interCommentTag."@bug "
  exec "normal o".s:interCommentTag."@warning "
  exec "normal o".s:interCommentTag."@note "
  exec "normal o".s:interCommentTag."@see "
  exec "normal o".s:interCommentTag."@copyright ".g:DoxygenToolkit_licenseTag
  if ( g:DoxygenToolkit_endCommentTag != "" )
    exec "normal o".s:endCommentTag
  endif
...
function! s:InitializeParameters()
  if( s:CheckFileType() == "cpp" )
    let s:startCommentTag   = g:DoxygenToolkit_startCommentTag." ".g:DoxygenToolkit_briefTag_pre
    ...
    let s:startCommentTag   = "## ".g:DoxygenToolkit_briefTag_pre
